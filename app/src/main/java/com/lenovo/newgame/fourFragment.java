...
public class fourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        t1 = (TextView)v.findViewById( R.id.tableshow );
        number =(TextInputEditText)v.findViewById( R.id.inputnumber );
        ...
        btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                t1.setText( null );
                int j = Integer.parseInt( number.getText().toString() );
                String result;
                if(j<=199){
                for (int i = 1; i <= 10; i++) {
                    result = (j + "      X     " + i + "      =     " + i * j);
                    ...
                    t1.setText( "Please enter the number between 1-199" );
                }
            }
        } );
